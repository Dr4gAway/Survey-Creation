...
import {LinkIcon, PhotoIcon, PlusCircleIcon, TrashIcon} from "@heroicons/react/24/outline/index.js";
...
export default function SurveyView() {
  ...
  function onSubmit(ev) {
    ...
    .then(res => {
      ...
      navigate('/Surveys')
      if(id) {
        showToast(`The survey was udpated!`)
      } else {
        ...
        <form action="#" method="POST" onSubmit={onSubmit}>
          <div className="shadow sm:overflow-hidden sm:rounded-md">
            <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
              {errors && (<div className="bg-red-500 text-white py-3 px-3">{errors}</div>)}
