...
export default function TButton({
  ...
  if (link) {
    ...
    switch(color) {
      case "indigo":
        classes = [...classes, "bg-indigo-600", "hover-indigo-700","focus:ring-indigo-500"];
        break;
      
      case "red":
        classes = [...classes, "bg-red-600", "hover-red-700","focus:ring-red-500"];
        break
  ...
  return (
    <>
      ...
      {!to && !href && (
        <button onClick={onDeleteClick} className={classes.join(" ")}>{children}</button>
      )}
    </>
  )
}
